...
use App\Models\BidWebConfigs;

class ApiResponse
{
    /**
     * Swagger responses definition
     *
     * @OA\Response(response="200", description="Success."),
     * @OA\Response(response="201", description="Create success."),
     * @OA\Response(response="204", description="Delete success."),
     * @OA\Response(response="400", description="Bad Request."),
     * @OA\Response(response="401", description="Unauthorized action."),
